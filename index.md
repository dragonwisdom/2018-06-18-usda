...
carpentry: "Data or Software"    # what kind of Carpentry (must be either "lc" or "dc" or "swc")
venue: "NEA"        # brief name of host site without address (e.g., "Euphoric State University")
address: "10300 Baltimore Ave Beltsville MD"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
collaborative_notes:http://pad.software-carpentry.org/2018-0618-usda            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
